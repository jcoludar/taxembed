...
def main():
    ...
    if check_file_exists("small_model_28epoch/taxonomy_model_small_best.pth", "Best model"):
        check_model("small_model_28epoch/taxonomy_model_small_best.pth", torch.Size([92290, 10]))

    all_passed &= check_file_exists(
        "small_model_28epoch/taxonomy_embeddings_multi_groups.png", "Multi-group viz"
    )
    all_passed &= check_file_exists(
        "small_model_28epoch/best_epoch_analysis_epoch28.png", "Epoch analysis"
    )
    print()
